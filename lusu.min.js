...
function(a){void 0!==b.error&&'function'===typeof b.error&&b.error(a)};request.send()},doc:{ready:function(a){document.addEventListener?document.addEventListener('DOMContentLoaded',a):document.attachEvent('onreadystatechange',function(){'interactive'===document.readyState&&a()})}},history:{regex:/<body\s*[^>]*>([\S\s]*?)<\/body>/i,push:function(a){void 0!==a&&void 0!==history&&void 0!==history.pushState&&(history.pushState({page:a},'',a),this.done(a))},done:function(a){lusu.get(a,function(a){document.body.innerHTML=
